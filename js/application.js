...
(function() {
  var highlight_code, round_all_img, setup_facebook_js, setup_google_analytics, setup_twitter_js;
  ...
  round_all_img = function() {
    return $("img:not(img[class])").addClass('img-rounded');
  };
